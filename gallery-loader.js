...
const interiorImages = [
    { id: 'interior-3', alt: "Intérieur de la boutique avec objets et meubles vintage" },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateHTML(image, type, index) {
        ...
        // CSS UPDATES:
        // Added 'snap-always' to force stopping at each image.
    ...
    function renderGallery(containerId, images, type) {
        ...
        const html = images.map((img, index) => generateHTML(img, type, index)).join('');
